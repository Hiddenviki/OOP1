...
void showMenu(int* a)
{
    ...
    cout << "3. Найти товар по названию" << endl;
    cout << "4. Найти все товары секции" << endl;
    cout << "5. Рассортировать товары по уменьшению их количества" << endl;
    cout << "6. Сохранить изменения на диск и выйти" << endl;
    cout<<endl;
